...
export const TermsPage: React.FC = () => {
  return (
    <>
      <SEOHead
        title="Terms of Service - CharacterForge"
        description="Terms of Service for CharacterForge - AI character and avatar generation for apps, games, and design."
        url="https://characterforge.app/terms"
      />
